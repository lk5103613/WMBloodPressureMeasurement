...
public class SettingData {
	...
	public SettingData(String settingName, Intent targetIntent, Context context) {
		this.settingName = settingName;
	...
	public SettingData(String settingName, String subContent, Intent targetIntent, Context context) {
		this.settingName = settingName;
		this.subContent = subContent;
		this.hasMoreContent = true;
		this.hasSubContent = true;
