...
public class PropertiesSharePrefs {
	...
	public void saveState(String type, String value) {
		SharedPreferences.Editor editor = mSharePreferences.edit();
		editor.putString(type, value);
		editor.commit();
	}

	public boolean getState(String type, boolean defaultValue) {
		return mSharePreferences.getBoolean(type, defaultValue);
	}
	
	public String getState(String type, String defaultValue) {
